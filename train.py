...
if __name__ == '__main__':
    ...
    parser.add_argument('--nw', dest="nw", type=int, default=1,
    ...
    parser.add_argument('--newdir', dest="newdir", type=bool, default=False, #For new training, this has to be changed to True
						help="Is this a new model?")
    parser.add_argument('--newtrain', dest="newtrain", type=bool, default=False, #For new training, this has to be changed to True
